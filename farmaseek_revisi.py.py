...
class FrameCariObat(tk.Frame):
    def __init__(self, master):
        ...
        ttk.Button(tombol_frame, text="Visualisasi Trie \U0001F4C8", command=self.visualisasi_trie).grid(row=0, column=1, padx=5)
...
if __name__ == "__main__":
    trie_nama, trie_gejala = muat_data_csv("data obat baru fix.csv")
    app = App()
    app.mainloop()
